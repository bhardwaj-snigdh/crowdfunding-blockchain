...
const CampaignDetails = () => {
  ...
  const fetchTotalCreatedCampaigns = async () => {
    const data = await getCampaignsParticularUser(state.owner);
    setCreatorTotalCampaigns(data.length);
  };

  useEffect(() => {
    if (contract) {
      fetchDonators();
      fetchTotalCreatedCampaigns();
    }
  }, [contract, address]);
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                <p className="mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]">
                  {`${creatorTotalCampaigns} ${
                    creatorTotalCampaigns > 1 ? 'Campaigns' : 'Campaign'
                  }`}
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="mt-[20px]">
              <pre className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify whitespace-pre-wrap">
                {state.description}
              </pre>
            </div>
          </div>
